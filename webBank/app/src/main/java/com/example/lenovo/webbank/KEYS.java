...
public class KEYS {
    public static String key2="MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQCJjTX/EejTxT2etKWASpoPxz0r\n" +
    ...
    public static String CA_PUBLIC_KEY="MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAiibKudYiLMyazBShN9OH+nnxqWs2r+VT\n" +
