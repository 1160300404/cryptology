...
import com.example.lenovo.webbank.AESUtil;
import com.example.lenovo.webbank.KEYS;
import com.example.lenovo.webbank.RSACoder;
...
public class RSA_AES {
    ...
    public static String serverDecrypt(String content) throws Exception{
        ...
        PrivateKey serverPrivateKey = RSACoder.string2PrivateKey(KEYS.key2);
        //用Server私钥解密AES秘钥
